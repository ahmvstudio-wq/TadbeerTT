  ...
  return (
    <section id="clients" className="clients-section" style={{ padding: '6rem 0', background: '#FDFDFB' }}>
      <div className="container" style={{ padding: '0 5%' }}>
        ...
        {/* Quick Problem Clarity Section */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '4rem', marginBottom: '6rem', alignItems: 'center' }}>
        ...
        <div className="text-center" style={{ maxWidth: '800px', margin: '0 auto 3rem' }}>
          <span className="section-label" style={{ color: 'var(--secondary)', display: 'inline-block', marginBottom: '0.75rem' }}>Trust</span>
          <h2 style={{ 
            fontSize: '2.2rem', 
            color: 'var(--primary)', 
            fontWeight: '800', 
            ...
            Trusted by leading organisations in Oman and the GCC
          </h2>
          <p style={{ 
            color: 'var(--text-muted)', 
            fontSize: '1rem', 
            ...
            We support transformation that improves operational stability, decision speed, and accountability without disrupting daily performance.
          </p>
        </div>
